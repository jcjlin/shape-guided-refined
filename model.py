...
class encoder_BN(nn.Module):
    def __init__(self):
        ...
        #self.conv11 = torch.nn.Conv1d(3, 16, 1)#我改的
        #self.conv12 = torch.nn.Conv1d(16, 64, 1)#我改的
        self.conv2 = torch.nn.Conv1d(64, 128, 1)
        self.conv3 = torch.nn.Conv1d(128, 1024, 1)
        self.fc1 = nn.Linear(1024, 512)
        self.fc2 = nn.Linear(512, 128)
        self.relu = nn.ReLU()
        #self.bn0 = nn.BatchNorm1d(16)  #改
    ...
    def forward(self, x):
        ...
        #x = F.relu(self.bn0(self.conv11(x)))#我改的
        #x = F.relu(self.bn1(self.conv12(x)))#我改的
